...
<section id="mvv" class="mvv">
    <div class="container-full">
        <div class="row">
            ...
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2023/11/shutterstock_1974822152.jpg" alt="Mission" class="round">
        </div>
        <div class="row">
        ...
        <div class="row">
            <img src="<?php echo site_url(); ?>/wp-content/uploads/2024/01/shutterstock_375512857.jpg" alt="Mission" class="round">
